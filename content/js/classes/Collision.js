class Collision {
    ...
    checkCollsion() {
        ...
        if ((this.middle.x - scene.player.middle.x * this.middle.x - scene.player.middle.x) + (this.middle.y - scene.player.middle.y * this.middle.y - scene.player.middle.y) <= this.diameterSQR + scene.player.diameterSQR + scene.player.speed[0] * 2) {
            ...
            if (!(((scene.player.pos.y + scene.player.height + scene.player.velocity[1]) <= (this.pos[1])) ||
                ...
                // player will be in the collision. put player out of collision... somehow ._.
            }
        }
    }
}